...
<div class="container mt-2 ms-5 text-center">
    ...
    <div class="border mx-auto mt-5  p-5 rounded shadow w-75 <?php echo !isset($almacenar->id) ? 'border-primary' : 'border-warning'  ;?>"">
        <form action="?controller=Personal&accion=Guardar" class="d-flex flex-column" enctype="multipart/form-data" id="formulario" method="POST">
            ...
            <div>
                ...
                <!-- <a href="?controller=Personal" class="btn btn-danger mx-5"> Cancelar </a> -->
