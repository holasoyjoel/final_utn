...
<div class="border mt-1 ms-5 pt-2 p-3 text-center w-75">
    ...
    <table class="table table-hover">
        ...
        <tbody>
            <?php foreach(isset($almacenar->filtrar)? ($this->model->Filtrar($almacenar->termino)) : ($this->model->Listar()) as $registro): ?>
                <tr>
                    ...
                    <td> <a href="?controller=Cliente&accion=VerDetalle&id=<?php echo $registro->id;?>" id="btnEditar" class="btn btn-success">Ver</a> </td>
                
                    <td>
                        <a 
                            href="?controller=Cliente&accion=Eliminar&id=<?php echo $registro->id;?>" 
                            id="btnEditar"
                            onclick="javascript:return confirm('Se eliminara al Cliente y los trabajos realizados sobre este. ¿Seguro de eliminar?')"
